    ...
    <div class="container content-first">
        <div class="common-columns exercise-data content">
            <div class="exercise-item">
                ...
                <a id="walk" class="plane-colored-btn btn row-btn">记录数据</a>
            </div>
            <div class="exercise-item">
                ...
                <a id="brisk" class="plane-colored-btn btn" href="/data/brisk">记录数据</a>
            </div>
            <div class="exercise-item">
                ...
                <a id="run"class="plane-colored-btn btn" href="/data/brisk">记录数据</a>
            </div>
        </div>
        <div class="health-data health-data content common-columns">
            <div class="health-item height">
                ...
                <a id="height"class="plane-colored-btn btn" href="/data/walk">记录数据</a>
            </div>
            <div class="health-item weight">
                ...
                <a id="weight"class="plane-colored-btn btn" href="/data/brisk">记录数据</a>
            </div>
            <div class="health-item water">
                ...
                <a id="water"class="plane-colored-btn btn" href="/data/brisk">记录数据</a>
            </div>
        </div>
            ...
            <div class="statistics-control common-columns">
                <div class="common-column control-group">
                    <select class="form-control option-select">
                        ...
                        <option>体重</option>
                        <option>饮水量</option>
                        <option>每周步数总和</option>
                        <option>每周健走距离总和</option>
                        <option>每周健走平均速度</option>
                        <option>每周跑步距离总和</option>
                        <option>每周跑步平均速度</option>
                    </select>
                </div>
